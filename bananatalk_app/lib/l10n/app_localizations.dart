...
abstract class AppLocalizations {
  ...
  /// Headline of the weekly AI Study promo modal
  ///
  /// In en, this message translates to:
  /// **'Practice real conversations'**
  String get aiStudyPromoTitle;

  /// Body text of the AI Study promo modal
  ///
  /// In en, this message translates to:
  ...
  /// Primary CTA of the AI Study promo modal
  ///
  /// In en, this message translates to:
  /// **'Try practice scenarios'**
  String get aiStudyPromoCTA;

  /// Dismiss button of the AI Study promo modal
  ///
  /// In en, this message translates to:
  /// **'Maybe later'**
