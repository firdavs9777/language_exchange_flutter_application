...
class CityTab extends ConsumerStatefulWidget {
  ...
  const CityTab({super.key, required this.filters, required this.searchQuery});
...
class _CityTabState extends ConsumerState<CityTab> {
  ...
  final List<_CountryPin> _countryPins = [
    ...
    _CountryPin(
      name: 'United States',
      flag: '🇺🇸',
      position: const LatLng(39.8283, -98.5795),
    ),
    _CountryPin(
      name: 'China',
      flag: '🇨🇳',
      position: const LatLng(35.8617, 104.1954),
    ),
    _CountryPin(
      name: 'United Kingdom',
      flag: '🇬🇧',
    ...
    _CountryPin(
      name: 'Germany',
      flag: '🇩🇪',
      position: const LatLng(51.1657, 10.4515),
    ),
    _CountryPin(
      name: 'France',
      flag: '🇫🇷',
      position: const LatLng(46.2276, 2.2137),
    ),
    _CountryPin(
      name: 'Spain',
      flag: '🇪🇸',
      position: const LatLng(40.4637, -3.7492),
    ),
    _CountryPin(
      name: 'Brazil',
      flag: '🇧🇷',
      position: const LatLng(-14.2350, -51.9253),
    ),
    _CountryPin(
      name: 'India',
      flag: '🇮🇳',
    ...
    _CountryPin(
      name: 'Russia',
      flag: '🇷🇺',
      position: const LatLng(61.5240, 105.3188),
    ),
    _CountryPin(
      name: 'Turkey',
      flag: '🇹🇷',
      position: const LatLng(38.9637, 35.2433),
    ),
    _CountryPin(
      name: 'Indonesia',
      flag: '🇮🇩',
      position: const LatLng(-0.7893, 113.9213),
    ),
    _CountryPin(
      name: 'Thailand',
      flag: '🇹🇭',
      position: const LatLng(15.8700, 100.9925),
    ),
    _CountryPin(
      name: 'Vietnam',
      flag: '🇻🇳',
      position: const LatLng(14.0583, 108.2772),
    ),
    _CountryPin(
      name: 'Philippines',
      flag: '🇵🇭',
      position: const LatLng(12.8797, 121.7740),
    ),
    _CountryPin(
      name: 'Mexico',
      flag: '🇲🇽',
    ...
    _CountryPin(
      name: 'Italy',
      flag: '🇮🇹',
      position: const LatLng(41.8719, 12.5674),
    ),
    _CountryPin(
      name: 'Canada',
      flag: '🇨🇦',
      position: const LatLng(56.1304, -106.3468),
    ),
    _CountryPin(
      name: 'Australia',
      flag: '🇦🇺',
      position: const LatLng(-25.2744, 133.7751),
    ),
    _CountryPin(
      name: 'Uzbekistan',
      flag: '🇺🇿',
      position: const LatLng(41.3775, 64.5853),
    ),
    _CountryPin(
      name: 'Taiwan',
      flag: '🇹🇼',
      position: const LatLng(23.6978, 120.9605),
    ),
    _CountryPin(
      name: 'Malaysia',
      flag: '🇲🇾',
      position: const LatLng(4.2105, 101.9758),
    ),
    _CountryPin(
      name: 'Saudi Arabia',
      flag: '🇸🇦',
      position: const LatLng(23.8859, 45.0792),
    ),
    _CountryPin(
      name: 'Egypt',
      flag: '🇪🇬',
      position: const LatLng(26.8206, 30.8025),
    ),
    _CountryPin(
      name: 'Argentina',
      flag: '🇦🇷',
      position: const LatLng(-38.4161, -63.6167),
    ),
    _CountryPin(
      name: 'Colombia',
      flag: '🇨🇴',
      position: const LatLng(4.5709, -74.2973),
    ),
    _CountryPin(
      name: 'Nigeria',
      flag: '🇳🇬',
      position: const LatLng(9.0820, 8.6753),
    ),
    _CountryPin(
      name: 'Pakistan',
      flag: '🇵🇰',
      position: const LatLng(30.3753, 69.3451),
    ),
    _CountryPin(
      name: 'Bangladesh',
      flag: '🇧🇩',
          ...
          batch.map((pin) async {
            try {
              final result = await service.getCommunityPaginated(
                ...
                limit: 1,
                country: pin.name,
                nativeLanguage: (lang.native?.isNotEmpty ?? false)
                    ? lang.native
                    : null,
                learningLanguage: (lang.learning?.isNotEmpty ?? false)
                    ? lang.learning
                    : null,
  ...
  Widget _buildWorldwideCard() {
    ...
    final topCountries = _countryPins.where((p) => p.userCount > 0).toList()
  ...
  Widget _buildAvatarStack(int total) {
    ...
    final width =
        avatarSize +
        (preview.length - 1).clamp(0, 4) * overlap +
            ...
            children: [
              ...
              if (_users.isNotEmpty)
                Text(
                  AppLocalizations.of(
                    context,
                  )!.usersCount(_users.length.toString()),
