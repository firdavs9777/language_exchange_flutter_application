...
/// Free-text occupation edit. Capped at 80 chars (backend `User.occupation`
/// `maxlength: 80`). Mirrors [ProfileBioEdit] but without the decoration
/// helpers — occupation is a single short line, not a paragraph.
...
class _OccupationEditState extends ConsumerState<OccupationEdit> {
  ...
  void initState() {
    super.initState();
    _controller = TextEditingController(text: widget.currentOccupation);
  ...
  void _onTextChange() {
    final hasChanges =
        _controller.text.trim() != widget.currentOccupation.trim();
  ...
  Future<void> _save() async {
    ...
    try {
      await ref
          ...
          .updateOccupation(occupation: _controller.text.trim());
            ...
            AnimatedContainer(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'e.g. Software Engineer, Student, Designer',
