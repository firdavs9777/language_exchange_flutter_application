...
class _TranslatedCommentWidgetState extends State<TranslatedCommentWidget> {
  ...
  Future<void> _tryAutoTranslate() async {
    // Check if auto-translate is enabled for comments
    final shouldAuto = await TranslationService.shouldAutoTranslate('comments');
  ...
  Future<void> _translateTo(String languageCode) async {
    ...
    try {
      final result = await TranslationService.translateComment(
